...
function RockobitsTransactionsEmployee({ selectedEmployee }) {
  ...
  const fetchTransactions = async () => {
    setIsLoading(true);
    try {
      const response = await api.get(`transactions/rockobits/${selectedEmployee.id}`, {
        params: {
          skip: page * take,
          take,
          isEmployee: true,
...
export default RockobitsTransactionsEmployee;

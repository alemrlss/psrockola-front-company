  ...
  resources: {
    en: {
      translation: {
        ...
        menu_logout: "Logout",
        view_employees_transfer_title: "Transfer Rockobits",
        view_employees_tranfer_amount: "Amount",
        view_employees_transfer_select: "Select Employee",
        view_employees_transfer_btn: "Transfer",
        view_memberships_cancel_title: "Active Membreship:",
        view_memberships_cancel_type: "Type Membership:",
        view_memberships_cancel_devices: "Sales Devices:",
        view_memberships_cancel_benefits: "Benefits",
        view_memberships_cancel_modeplays: "Custom Modeplays:",
        view_memberships_cancel_btn_cancel: "Cancel Membership",
        view_memberships_cancel_modal_description:
          "Are you sure you want to cancel your membership?",
        view_memberships_cancel_modal_btn_confirm: "Confirm Cancelation",
        view_memberships_cancel_modal_btn_cancel: "Cancel",
        view_memberships_cancel_no_membershio: "No active membership",
        view_transactions_tabbar_pay: "Pay",
        ...
        view_transactions_pagination_rows: "Rows per page",
        view_transactions_no_transactions: "No transactions found",
        view_trasactions_loading: "Loading...",
        view_currentplays_title: "Current Plays",
        view_currentplays_ban_selected: "Ban Selected",
        view_currentplays_selected: "Selected",
        view_currentplays_ban: "Ban",
        view_currentplays_no_videos: "No videos to show",
        view_currentplays_show_playlist: "Show Playlist",
        view_currentplays_modal_message:
          "Are you sure you want to ban this video?",
      },
      view_currentplays_banning: "Banning video...",
      view_currentplays_modal_createdAt: "Created At:",
      view_currentplays_modal_duration: "Duration:",
      view_currentplays_modal_channelTitle: "Channel Title:",
      view_currentplays_modal_message_confirm: "Yes, i am sure",
      view_currentplays_modal_message_cancel: "No, Cancel",
      settings_change_password: "Change Password",
      settings_update_user: "Update User",
      settings_update_photo: "Update Profile Photo",
      settings_update_user_name: "Name",
      settings_update_user_email: "Email",
      settings_update_user_address: "Address",
      settings_update_user_phone: "Phone",
      settings_update_user_postalCode: "Postal Code",
      settings_update_user_save: "Save",
      settings_change_password_current: "Current Password",
      settings_change_password_new: "New Password",
      settings_change_password_confirm: "Confirm New Password",
      settings_change_password_change: "Change",
      settings_update_photo_upload: "Upload Photo",
    },
    es: {
      translation: {
        ...
        view_employees_transfer_title: "Transferir Rockobits",
        view_employees_tranfer_amount: "Monto",
        view_employees_transfer_select: "Seleccionar Empleado",
        view_employees_transfer_btn: "Transferir",
        view_memberships_cancel_title: "Membresia Activa:",
        view_memberships_cancel_type: "Tipo de Membresia:",
        view_memberships_cancel_devices: "Dispositivos de Ventas:",
        view_memberships_cancel_benefits: "Beneficios:",
        view_memberships_cancel_modeplays: "Modeplays Personalizados:",
        view_memberships_cancel_btn_cancel: "Cancelar Membresia",
        view_memberships_cancel_modal_description:
          "¿Estás seguro de que deseas cancelar tu membresía?",
        view_memberships_cancel_modal_btn_confirm: "Confirmar Cancelación",
        view_memberships_cancel_modal_btn_cancel: "Cancelar",
        view_memberships_cancel_no_membershio: "No hay membresia activa",
        view_transactions_tabbar_pay: "Pago",
        ...
        view_transactions_pagination_rows: "Filas por página",
        view_transactions_no_transactions: "No se encontraron transacciones",
        view_trasactions_loading: "Cargando...",
        view_currentplays_title: "Reproducciones Actuales",
        view_currentplays_ban_selected: "Banear Seleccionado",
        view_currentplays_selected: "Seleccionado",
        view_currentplays_ban: "Banear",
        view_currentplays_no_videos: "No hay videos para mostrar",
        view_currentplays_show_playlist: "Mostrar Playlist",
        view_currentplays_modal_message:
          "¿Estás seguro de que quieres banear este video?",

        view_currentplays_banning: "Baneando video...",
        view_currentplays_modal_createdAt: "Creado en:",
        view_currentplays_modal_duration: "Duración:",
        view_currentplays_modal_channelTitle: "Título del canal:",
        view_currentplays_modal_message_confirm: "Sí, estoy seguro",
        view_currentplays_modal_message_cancel: "No, Cancelar",
        settings_change_password: "Cambio de Clave",
        settings_update_user: "Actualizar Usuario",
        settings_update_photo: "Actualizar Foto de Perfil",
        settings_update_user_name: "Nombre",
        settings_update_user_email: "Correo Electrónico",
        settings_update_user_address: "Dirección",
        settings_update_user_phone: "Teléfono",
        settings_update_user_postalCode: "Código Postal",
        settings_update_user_save: "Guardar",
        settings_change_password_current: "Contraseña Actual",
        settings_change_password_new: "Nueva Contraseña",
        settings_change_password_confirm: "Confirmar Nueva Contraseña",
        settings_change_password_change: "Cambiar",
        settings_update_photo_upload: "Subir Foto",
      },
    },
    pt: {
      translation: {
        ...
        menu_logout: "Sair",
        view_employees_transfer_title: "Transferir Rockobits",
        view_employees_tranfer_amount: "Quantidade",
        view_employees_transfer_select: "Selecione Funcionário",
        view_employees_transfer_btn: "Transferir",
        view_memberships_cancel_title: "Membresia Ativa:",
        view_memberships_cancel_type: "Tipo de Membresia:",
        view_memberships_cancel_devices: "Dispositivos de Vendas:",
        view_memberships_cancel_benefits: "Benefícios:",
        view_memberships_cancel_modeplays: "Modeplays Personalizados:",
        view_memberships_cancel_btn_cancel: "Cancelar Membresia",
        view_memberships_cancel_modal_description:
          "Tem certeza de que deseja cancelar sua associação?",
        view_memberships_cancel_modal_btn_confirm: "Confirmar Cancelamento",
        view_memberships_cancel_modal_btn_cancel: "Cancelar",
        view_memberships_cancel_no_membershio: "Nenhuma associação ativa",
        view_transactions_tabbar_pay: "Pagar",
        view_transactions_table_date: "Data",
        view_transactions_table_type: "Tipo",
        view_transactions_table_amount: "Quantidade",
        view_transactions_table_user: "Usuário",
        view_transactions_pagination_rows: "Linhas por página",
        view_transactions_no_transactions: "Nenhuma transação encontrada",
        view_trasactions_loading: "Carregando...",
        view_currentplays_title: "Reproduções Atuais",
        view_currentplays_ban_selected: "Banir Selecionado",
        view_currentplays_selected: "Selecionado",
        view_currentplays_ban: "Banir",
        view_currentplays_no_videos: "Nenhum vídeo para mostrar",
        view_currentplays_show_playlist: "Mostrar Playlist",
        view_currentplays_modal_message:
          "Tem certeza de que deseja banir este vídeo?",

        view_currentplays_banning: "Banindo vídeo...",
        view_currentplays_modal_createdAt: "Criado em:",
        view_currentplays_modal_duration: "Duração:",
        view_currentplays_modal_channelTitle: "Título do canal:",
        view_currentplays_modal_message_confirm: "Sim, tenho certeza",
        view_currentplays_modal_message_cancel: "Não, Cancelar",
        settings_change_password: "Alterar Senha",
        settings_update_user: "Atual",
        settings_update_photo: "Atualizar Foto de Perfil",
        settings_update_user_name: "Nome",
        settings_update_user_email: "Email",
        settings_update_user_address: "Endereço",
        settings_update_user_phone: "Telefone",
        settings_update_user_postalCode: "Código Postal",
        settings_update_user_save: "Salvar",
        settings_change_password_current: "Senha Atual",
        settings_change_password_new: "Nova Senha",
        settings_change_password_confirm: "Confirmar Nova Senha",
        settings_change_password_change: "Alterar",
        settings_update_photo_upload: "Carregar Foto",
      },
    },
  },
  lng: storedLanguage,
